<?php
return array (
  '<strong>Add</strong> OEmbed Provider' => '<strong>اضافه کردن</strong> تامین‌کننده‌ی OEmbed',
  '<strong>Edit</strong> OEmbed Provider' => '<strong>ویرایش</strong> تامین‌کننده‌ی OEmbed',
  'Delete' => 'حذف',
  'Save' => 'ذخیره',
