<div id="lightbox_requestWorkspace">
    ...
    <div class="panel panel_lightbox">
        <div class="content content_innershadow">
            ...
            <h2><?php echo Yii::t('SpaceModule.widgets_views_requestMembershipSave', 'Request circle membership'); ?></h2>

            <p>
                <?php echo Yii::t('SpaceModule.widgets_views_requestMembershipSave', 'Your request was successfully submitted to the circle administrators.'); ?><br/>
            </p>
            <br/>
