<?php
return array (
  '<strong>File</strong> settings' => 'Configurações de <strong>arquivos</strong>',
  'Comma separated list. Leave empty to allow all.' => 'Lista separada por vírgulas. Deixe em branco para permitir todos.',
  'Comma separated list. Leave empty to show file list for all objects on wall.' => 'Lista separada por vírgulas. Deixe em branco para exibir a lista de arquivos para todos os objetos no muro.',
