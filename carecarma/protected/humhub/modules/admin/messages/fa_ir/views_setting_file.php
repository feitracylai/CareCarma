<?php
return array (
  '<strong>File</strong> settings' => 'تنظیمات <strong>فایل</strong>',
  'Comma separated list. Leave empty to allow all.' => 'لیست جدا‌شده با کاما. برای اجازه‌ی همه خالی بگذارید.',
  'Comma separated list. Leave empty to show file list for all objects on wall.' => 'لیست جدا‌شده با کاما. برای نشان دادن لیست فایل برای همه‌ی موارد روی صفحه‌ی اعلانات، خالی بگذارید.',
