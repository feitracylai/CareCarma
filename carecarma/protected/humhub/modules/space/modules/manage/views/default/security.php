...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <p class="help-block"><?php echo Yii::t('SpaceModule.views_admin_edit', 'Choose the kind of membership you want to provide for this family.'); ?></p>
        <br>
        ...
        <p class="help-block"><?php echo Yii::t('SpaceModule.views_admin_edit', 'Choose the security level for this family to define the visibleness.'); ?></p>
