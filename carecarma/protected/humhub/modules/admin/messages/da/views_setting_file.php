<?php
return array (
  '<strong>File</strong> settings' => '<strong>Fil</strong> indstillinger',
  'Comma separated list. Leave empty to allow all.' => 'Komma separeret liste. Lad den være tom for at tillade alle.',
  'Comma separated list. Leave empty to show file list for all objects on wall.' => 'Komma separeret liste. Lad den være tom for at vise filliste for alle objekter på væggen.',
