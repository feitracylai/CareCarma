...
<?= \humhub\modules\space\modules\manage\widgets\CareEditMenu::widget(['space' => $space]); ?>
<br/>
...
<div class="panel-body">
    <?=\humhub\modules\space\modules\manage\widgets\ContactMenu::widget(['space' => $space]) ?>
    <p />
...
//                'user.profile.lastname',
                ...
                [
                    ...
                    'buttons' => [
                        'update' => function($url, $model) use ($user, $space) {
...
//                                return Html::a('<i class="fa fa-check"></i>', Url::toRoute(['/user/contact/link-accept', 'uguid' => $contactUser->guid]), ['class' => 'btn btn-primary btn-xs tt', 'title' => 'View']);
                        ...
                        'delete' => function($url, $model) use ($user, $space){
//                            return Html::a('<i class="fa fa-times"></i>', Url::toRoute(['/user/contact/link-cancel', 'id' => $model->contact_id]), ['class' => 'btn btn-danger btn-xs tt', 'data-confirm' => 'Are you sure?', 'data-method' => 'POST', 'title' => 'Cancel']);
                            return Html::a('<i class="fa fa-times"></i>', $space->createUrl('/user/contact/link-cancel', ['id' => $model->contact_id, 'rguid' => $user->guid]), ['class' => 'btn btn-danger btn-xs tt', 'data-confirm' => 'Are you sure?', 'data-method' => 'POST', 'title' => 'Cancel']);
