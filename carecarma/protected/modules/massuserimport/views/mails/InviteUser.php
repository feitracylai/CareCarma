                                                ...
                                                <tr>
                                                    <td width="auto"
                                                        ...
                                                        style="color: #555555; font-weight: 300;">
                                                            <?php echo Yii::t('MassuserimportModule.base', 'Welcome to %appName%', array('%appName%' => '<strong>' . Html::encode(Yii::$app->name) . '</strong>')); ?>
                                                        </span>
                                                    </td>
                                                </tr>
                                            </table> <!-- end button -->
                                            ...
                                            <table border="0"
                                                ...
                                                <tr>
                                                    <td
                                                    	...
                                                    	<?php echo Yii::t('MassuserimportModule.base', '%sender% has invited you to join %appName%! Please click on the button below to proceed with the registration.', array('%appName%' => Html::encode(Yii::$app->name), '%sender%' => Html::encode(Yii::$app->user->identity->username))); ?>
                                                ...
                                                <tr>
                                                    <td width="auto"
                                                        ...
                                                        style="color: #ffffff; font-weight: 300;">
                                                            <a
                                                            href="<?php echo Url::toRoute(["/user/auth/create-account", 'token' => $token], true); ?>"
                                                            style="text-decoration: none; color: #ffffff; font-weight: 300;">
                                                                <strong><?php echo Yii::t('MassuserimportModule.base', 'Create Account'); ?></strong>
                                                        </a>
                                                    </span>
                                                    </td>
