...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <p>
            <?php echo Yii::t('AdminModule.views_user_delete', 'Are you sure you want to delete this user? If this user is owner of some circles, <b>you</b> will become owner of these families.'); ?>
        </p>
