...
*/5 * * * * su -c php "<?php echo Yii::getAlias('@app/yii'); ?>  cron/hourly" <?php echo $currentUser; ?>
    >/dev/null 2>&1
0 22 * * * su -c php "<?php echo Yii::getAlias('@app/yii'); ?>  cron/daily" <?php echo $currentUser; ?> >/dev/null 2>&1
<?php endif; ?>
        </pre>
