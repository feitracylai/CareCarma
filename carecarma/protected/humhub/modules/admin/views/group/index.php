...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <p />
        <p>
            <?php echo Yii::t('AdminModule.views_groups_index', 'You can split users into different groups (for teams, departments etc.) and define standard cirecles and admins for them.'); ?>
        </p>
