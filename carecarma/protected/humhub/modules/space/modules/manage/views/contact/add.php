...
<div class="panel panel-default">
    <div class="panel-heading">
        <?php echo Yii::t('UserModule.views_contact_add', '<strong>Import</strong> contact'); ?>
    </div>
    ...
    <div class="panel-body">
        ...
        <div class="pull-right">
            <?php echo Html::a('<i class="fa fa-send"></i> '.Yii::t('UserModule.views_contact_add', 'Invite Contact'), $receiver->createUrl('invite'), array('class' => 'btn btn-info', 'data-target' => '#globalModal')); ?>
        </div>
        <!-- search form -->
        ...
        <?php foreach ($users as $user) : ?>
            ...
            <li>
                <div class="media" id="media-<?php echo $user->guid; ?>">
                    ...
                    <div class="pull-right" >
                        <?php echo Html::a('<i class="fa fa-plus"></i> '.Yii::t('UserModule.views_contact_connect', 'Add'), $space->createUrl('add', ['doit' => 2, 'connect_id' => $user->id, 'rguid' => $receiver->guid]), array('class' => 'btn btn-primary  pull-right', 'data-method' => 'POST', 'data-confirm' => 'Are you sure? Click "OK" if you want to add this user in your contact.')); ?>
                    </div>
