    ...
    $(document).ready(function () {
        ...
        interfaceTour.addSteps([
            ...
            },
            {
                ...
                content: <?php echo json_encode(Yii::t('TourModule.widgets_views_index', 'This is the most important menu and will probably be the one you use most often!<br><br>Access all the circles you have joined and create new families here.<br><br>The next guide will show you how:')); ?> + "<br><br><a href='javascript:gotoSpace = true; tourCompleted();'><?php echo Yii::t("TourModule.widgets_views_index", "<strong>Start</strong> circle guide"); ?></a><br><br>",
                placement: "bottom"
            }
        ]);
