<?php
return array (
  '<strong>CronJob</strong> settings' => '<strong>Ustawienia</strong> zadań cron',
  'Crontab of user: {user}' => 'Crontab użytkownika: {user}',
  'Last run (daily):' => 'Ostatnie wykonanie (dzienne):',
  'Last run (hourly):' => 'Ostatnie wykonanie (godzinne):',
  'Never' => 'Nigdy',
