<?php
return array (
  '<strong>CronJob</strong> settings' => 'Configurações de <strong>tarefas Agendadas</strong>',
  'Crontab of user: {user}' => 'Crontab do usuário: {user}',
  'Last run (daily):' => 'Última execução (daily):',
  'Last run (hourly):' => 'Última execução (hourly):',
  'Never' => 'Nunca',
