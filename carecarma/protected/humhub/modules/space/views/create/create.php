    ...
    <div class="modal-content">
        ...
        <div class="modal-header">
            ...
            <h4 class="modal-title"
                id="myModalLabel"><?php echo Yii::t('SpaceModule.views_create_create', '<strong>Create</strong> new circle'); ?></h4>
        </div>
        <div class="modal-body">
            ...
            <br>
            <div class="row">
                <div class="col-md-8"> <?php echo $form->field($model, 'name')->textInput(['id' => 'space-name', 'placeholder' => Yii::t('SpaceModule.views_create_create', 'circle name'), 'maxlength' => 45]); ?></div>
            ...
            <?php echo $form->field($model, 'description')->textarea(['placeholder' => Yii::t('SpaceModule.views_create_create', 'circle description'), 'rows' => '3']); ?>
