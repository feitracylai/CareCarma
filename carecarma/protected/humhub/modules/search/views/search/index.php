                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group form-group-search">
                                <?php echo Html::textInput('keyword', $keyword, array('placeholder' => Yii::t('SearchModule.views_search_index', 'Search for user, circles and content'), 'class' => 'form-control form-search', 'id' => 'search-input-field')); ?>
                            ...
                            <div id="collapse-search-settings" class="panel-collapse collapse">
                                <br>
                                <?php echo Yii::t('SearchModule.views_search_index', 'Search only in certain circles:'); ?>
                    ...
                    <div class="list-group">
                        ...
                        <a href='<?php echo Url::to(['/search/search/index', 'keyword' => $keyword, 'limitSpaceGuids' => $limitSpaceGuids, 'scope' => SearchController::SCOPE_SPACE]); ?>'
                           class="list-group-item <?php if ($scope == SearchController::SCOPE_SPACE): ?>active<?php endif; ?>">
                            <div>
                                <div
                                    class="edit_group "><?php echo Yii::t('SearchModule.views_search_index', 'Circles'); ?>
