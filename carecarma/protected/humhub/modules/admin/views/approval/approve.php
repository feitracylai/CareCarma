...
<div class="panel panel-default">
    <div class="panel-heading"><?php echo Yii::t('AdminModule.views_approval_approveUserAccept', 'Accept user: <strong>{displayName}</strong> ', array('{displayName}' => Html::encode($model->displayName))); ?></div>
